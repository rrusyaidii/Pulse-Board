    ...
    <div class="row project-cards">
      ...
      <div class="card">
        <div class="card-body">
          <div class="row">
            <div class="col-sm-12">
              <form class="needs-validation" novalidate="" action="<?= base_url('project/project/createProject') ?>"
                method="post">
                <?= csrf_field() ?>
                ...
                <div class="row g-3 mb-3">
                  <div class="col-md-6">
                    ...
                    <input class="form-control" id="name" name="name" type="text" placeholder="Enter project name"
                      required="">
                  </div>
                  <div class="col-md-6">
