                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-0 me-0"></div><a class="btn btn-primary"
                                    href="<?= base_url('project/project/create') ?>"> <i data-feather="plus-square">
                                    </i>Create New Project</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-xl-4 col-md-6 mb-4">
                                <div class="project-box border rounded-4 p-3 pb-0 h-100">
                                    ...
                                    <div class="row details mb-2">
                                        ...
                                        <div class="col-6 text-primary">RM <?= number_format($stats['contractValue'], 0) ?>
                                        </div>
                                    ...
                                    <div class="project-status mt-2 mb-4">
                                        <div class="media mb-1">
                                            ...
                                            <div class="media-body text-end">
                                                <span><?= esc(ucwords($project['status'])) ?></span></div>
                                        </div>
